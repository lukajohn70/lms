    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Promotion Banner - ONLY IN 3RD TERM */}
          {term === "3rd" && meta.promotion_decision && (
            <Glass style={{ padding: "14px 20px", marginBottom: 18, borderLeft: `4px solid ${meta.promotion_color || "#219EBC"}` }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
                <div>
                  <span style={{ fontSize: 10, fontWeight: 700, color: "var(--subtext)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Academic Board Annual Decision (Third Term)</span>
